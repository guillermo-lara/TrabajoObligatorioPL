...
public interface GramaticaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GramaticaParser#ctelistp}.
	 * @param ctx the parse tree
	 */
	void enterCtelistp(GramaticaParser.CtelistpContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaParser#ctelistp}.
	 * @param ctx the parse tree
	 */
	void exitCtelistp(GramaticaParser.CtelistpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GramaticaParser#defvarlistp}.
	 * @param ctx the parse tree
	 */
	void enterDefvarlistp(GramaticaParser.DefvarlistpContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaParser#defvarlistp}.
	 * @param ctx the parse tree
	 */
	void exitDefvarlistp(GramaticaParser.DefvarlistpContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GramaticaParser#formalparam}.
	 * @param ctx the parse tree
	 */
	void enterFormalparam(GramaticaParser.FormalparamContext ctx);
	/**
	 * Exit a parse tree produced by {@link GramaticaParser#formalparam}.
	 * @param ctx the parse tree
	 */
